...
export function PersonalCalendar({ view, date, events, canDelete = true }: Props) {
  ...
  return (
    <>
      ...
      {dialog && <EventDialog initialDate={dialog.date} event={dialog.event} canDelete={canDelete} onClose={() => setDialog(null)} />}
    </>
  );
}
