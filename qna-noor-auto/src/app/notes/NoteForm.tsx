      ...
      <div className="space-y-4">
        <Field label="Title *">
          <Input
            ...
            placeholder="e.g. 2003-2007 Honda Accord — front brake squeal at low speed"
          />
        </Field>
        ...
        <p className="text-xs text-zinc-500">
          Leave year/make/model blank for a universal note. Otherwise, this note
          will auto-surface on matching vehicles.
        </p>
