...
export const ACTIVITY_LABELS: Record<string, string> = {
  ...
  "expense.recurring_post": "Recurring expense posted",
  "income.recurring_post": "Recurring income posted",
  "recurring.create": "Repeating entry created",
  "recurring.update": "Repeating entry updated",
  "recurring.delete": "Repeating entry deleted",
  "recurring.pause": "Repeating entry paused",
