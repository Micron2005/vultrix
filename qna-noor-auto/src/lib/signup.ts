...
function welcomeHtml(p: {
  ...
  <div style="max-width:560px;margin:0 auto;font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif">
    ...
    <p style="margin:22px 0 0;color:#a1a1aa;font-size:13px;line-height:1.5">
      Need a hand getting started? Just reply to this email — a real person (a working mechanic) will help.</p>
    <p style="margin:8px 0 0;color:#a1a1aa;font-size:13px;line-height:1.5">
      Subscription or payment questions go to ${escapeHtml(SALES_EMAIL)}.
    </p>
  </div>`;
}
